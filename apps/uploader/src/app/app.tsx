...
import { Button, UploadFileRegistration, UploadFileStatusesTable, UploadFileStatusRow } from '@gainhow-review/ui';
export function App() {
...
function GeneralUploader(): JSX.Element {
  ...
  function addFiles(fileObjects: File[]): void {
    let newFiles = (fileObjects.map((fileObject: File) => {
      return {
        fileObject,
        progress: 0,
        status: "REGISTERED" as "REGISTERED" | "UPLOADING" | "FINISHED" | "CANCELED" | "FAILED",
